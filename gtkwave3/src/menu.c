...
static gtkwave_mlist_t menu_items[] =
{
    ...
    WAVE_GTKIFE("/Time/Zoom/Zoom In", "<Control>equal", service_zoom_in_marshal, WV_MENU_TZZI, "<Item>"),
    WAVE_GTKIFE("/Time/Zoom/Zoom Out", "<Control>minus", service_zoom_out_marshal, WV_MENU_TZZO, "<Item>"),
    WAVE_GTKIFE("/Time/Zoom/Zoom Full", NULL, service_zoom_full_marshal, WV_MENU_TZZBFL, "<Item>"),
    WAVE_GTKIFE("/Time/Zoom/Zoom Best Fit", "<Control>0", service_zoom_fit_marshal, WV_MENU_TZZBF, "<Item>"),
